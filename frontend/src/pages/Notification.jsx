    ...
    <div className='max-w-4xl mx-auto px-4 py-4 sm:py-8'>
      <div className='flex items-center justify-between mb-6 sm:mb-8'>
        <div className='flex items-center gap-2 sm:gap-4'>
          ...
          <div>
            <h1 className='text-3xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent'>Notifications</h1>
            <p className='text-gray-500 text-sm mt-1'>Manage your friend requests</p>
          </div>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className='space-y-4'>
            {receivedRequests.map((user) => (
              <div 
                key={user._id}
                className='bg-white rounded-2xl border border-gray-100 p-5 flex items-center justify-between hover:shadow-xl transition-all duration-300'
              >
                <div className='flex items-center gap-4'>
                  <div 
                    className='w-16 h-16 rounded-full bg-linear-to-br from-purple-400 to-pink-400 overflow-hidden cursor-pointer ring-4 ring-purple-100 hover:ring-purple-200 transition-all'
                  ...
                  <div>
                    ...
                    <p className='text-gray-500 text-sm'>wants to be friends</p>
                  </div>
                </div>
                ...
                <div className='flex gap-3'>
                  <button
                    ...
                    className='bg-linear-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-5 py-2.5 rounded-xl transition-all shadow-md hover:shadow-lg flex items-center gap-2 font-semibold transform hover:scale-105'
                  >
                  ...
                  <button
                    ...
                    className='bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2.5 rounded-xl transition-all flex items-center gap-2 font-semibold'
                  >
